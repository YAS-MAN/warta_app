...
import 'rw_rt_residents_view.dart'; // Will be created next

class RwResidentsView extends StatefulWidget {
  final String kelurahan;
  final String rw;

  const RwResidentsView({
    super.key,
  ...
  @override
  State<RwResidentsView> createState() => _RwResidentsViewState();
}

class _RwResidentsViewState extends State<RwResidentsView> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          _buildPremiumHeader(context, 'Data Penduduk Per RT'),
          Padding(
  ...
  Widget _buildRtList() {
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (docs.isEmpty) {
          return const Center(child: Text('Belum ada data RT di wilayah ini.'));
        }
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.home_work, color: Color(0xFF8B0000)),
            ),
