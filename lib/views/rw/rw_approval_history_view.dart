          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              ...
              builder: (context, snapshot) {
                ...
                // RW history includes anything processed beyond RT (PROSES LURAH, BERHASIL, DITOLAK)
                // Actually if RW rejected, it's DITOLAK. If RW approved, it's PROSES LURAH or BERHASIL later.
                final histories =
                    docs
                        .map(SuratSubmissionModel.fromFirestore)
                        .where(
                          (item) =>
                              item.status == 'PROSES LURAH' ||
                ...
                if (histories.isEmpty) {
                  return const Center(
                    child: Text('Belum ada riwayat persetujuan surat RW.'),
                  );
                }
